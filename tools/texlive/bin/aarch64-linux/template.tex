...
\begin{frame}
	...
	\begin{equation}
		\frac{dx}{dy}=\frac{1}{\frac{dy}{dx}}
	\end{equation}
	\begin{exampleblock}{Ein einfaches Beispiel, das häufig bei Differentialgleichungen auftritt, bei denen die Ableitung dieser Funktion integriert wird, ist die Ableitung von $\ln(x)$ nach x.}
	\begin{equation}
		\frac{d\ln(y)}{dy}=\frac{1}{\frac{de^x}{dx}}=\frac{1}{e^x}=\frac{1}{y}
	\end{equation}
	\end{exampleblock}
	\begin{block}{Damit ist das häufig bei Differentialgleichungen auftretende Integral über $\frac{1}{x}$:}
	\begin{equation}

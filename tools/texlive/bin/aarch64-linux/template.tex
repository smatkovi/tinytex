...
\begin{frame}
	...
	\begin{equation}
		a_n(x)\cdot y^{(n)} + a_{n-1}(x)\cdot y^{(n-1)} + ... + a_1(x)\cdot y' + a_0(x)\cdot y = g(x)
	\end{equation}
	...
	\begin{enumerate}
		\item Satz 1: Die homogene Dgl. n-ter Ordnung besitzt genau n voneinander linear unabh\"angige Lösungen $y_1$, ... , $y_n$, deren Linearkombination die allgemeine L\"sung der Dgl. darstellt. 

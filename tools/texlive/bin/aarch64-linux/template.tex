...
\begin{frame}
	\begin{exampleblock}{}
		Die Kraft ist nach dem 1. Newton'schen Axiom $m\cdot a = m\cdot\frac{d^2m}{dt^2}=m\cdot \ddot{x}$, wobei a die Beschleunigung ist. So lautet dann die Dgl.
		\begin{equation}
		...
		\begin{equation}
			x(t) = C_1\cdot \cos\left(\frac{k}{m}\cdot t\right) + C_2\cdot \sin\left(\frac{k}{m}\cdot t\right)
		\end{equation}
	\end{exampleblock}
\end{frame}
\begin{frame}

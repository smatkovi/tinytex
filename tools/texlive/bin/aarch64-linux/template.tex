...
\begin{frame}
	\begin{definition}
		Es gibt noch die Unterscheidung zwischen \alert{homogen} und \alert{inhomogen}. Bei inhomogenen Dgln. tritt noch ein Ausdruck auf, der von der Variablen abh\"angt, von der die gesuchte Funktion abh\"angt, beziehungsweise einer Konstanten.
	\end{definition}
	\begin{exampleblock}{Beispiel}
